...
| [list](https://docs.oracle.com/en-us/iaas/tools/oci-cli/3.16.0/oci_cli_docs/cmdref/os/bucket/list.html) | `╰─ oci os bucket list --compartment-id <compartment-id> | jq '.data[] | {name} '`